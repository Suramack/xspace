...
//
//     final getRocketListResponseModel = getRocketListResponseModelFromJson(jsonString);

import 'dart:convert';

List<RocketListResponseModel> getRocketListResponseModelFromJson(
        String str) =>
    List<RocketListResponseModel>.from(
        json.decode(str).map((x) => RocketListResponseModel.fromJson(x)));

String getRocketListResponseModelToJson(
        List<RocketListResponseModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class RocketListResponseModel {
  RocketListResponseModel({
  ...
  factory RocketListResponseModel.fromJson(Map<String, dynamic> json) =>
      RocketListResponseModel(

...
//
//     final rocketDetailsResponseModel = rocketDetailsResponseModelFromJson(jsonString);

import 'dart:convert';

RocketDetailsResponseModel rocketDetailsResponseModelFromJson(String str) =>
    RocketDetailsResponseModel.fromJson(json.decode(str));

String rocketDetailsResponseModelToJson(RocketDetailsResponseModel data) =>
    json.encode(data.toJson());

class RocketDetailsResponseModel {
  RocketDetailsResponseModel({
  ...
  factory RocketDetailsResponseModel.fromJson(Map<String, dynamic> json) =>
      RocketDetailsResponseModel(
